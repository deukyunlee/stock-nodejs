CREATE TABLE IF NOT EXISTS daily (symbol VARCHAR(50), date DATE NOT NULL, open DECIMAL(10,4) NOT NULL, high DECIMAL(10,4) NOT NULL, low DECIMAL(10,4) NOT NULL, close DECIMAL(10,4) NOT NULL, volume INT NOT NULL, change_percent DECIMAL(10,4), change_value DECIMAL(10,4), constraint daily_PK primary key(symbol, date));

CREATE TABLE IF NOT EXISTS intraday (symbol VARCHAR(50), datetime DATETIME NOT NULL, open DECIMAL(10,4) NOT NULL, high DECIMAL(10,4) NOT NULL, low DECIMAL(10,4) NOT NULL, close DECIMAL(10,4) NOT NULL, volume INT NOT NULL, change_percent DECIMAL(10,4), change_value DECIMAL(10,4), constraint daily_PK primary key(symbol, datetime));
