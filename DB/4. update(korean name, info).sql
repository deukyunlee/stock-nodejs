...
UPDATE company_info SET kr_name = "에어비엔비", kr_desc = "에어비앤비(Airbnb, Inc.)는 미국 캘리포니아주 샌프란 
시스코에 위치한 숙박업소, 주로 휴가 임대업, 관광업 등을 위한 온라인 마켓플레이스를 운영하는 회사이다." WHERE symbol = "ABNB";
UPDATE company_info SET kr_name = "아날로그디바이스", kr_desc = "아날로그 디바이스스(ADI)는 데이터 변환, 신호 
처리 및 전력 관리 기술을 전문으로 하는 미국의 다국적 반도체 기업이다." WHERE symbol = "ADI";
UPDATE company_info SET kr_name = "어플라이드 머티어리얼즈", kr_desc = "어플라이드 머티리얼스(Applied Materials, Inc.)는 전자제품용 반도체(집적회로) 칩, 컴퓨터용 평면 디스플레이, 스마트폰 및 텔레비전용 디스플레이, 태양광  
제품 제조를 위한 장비, 서비스 및 소프트웨어를 공급하는 미국 기업이다. 또한 유연한 전자 제품, 포장 및 기타 용도 
의 코팅을 생산하기 위한 장비도 공급하고 있습니다. 본사는 미국 캘리포니아주 샌타클래라에 있다." WHERE symbol = "AMAT";
UPDATE company_info SET kr_name = "암젠", kr_desc = "암젠(Amgen)은 미국 캘리포니아주 사우전드오크스에 본사를 둔
 바이오 제약 회사이다. 분자생물학과 생화학에 초점을 맞춘 이 회사의 목표는 재조합 DNA 기술을 기반으로 한 헬스케 
어 사업을 제공하는 것이다." WHERE symbol = "AMGN";
...
UPDATE company_info SET kr_name = "앤섬", kr_desc = "앤섬은 미국의 의료보험회사이다. 블루크로스 블루실드 협회에
서 가장 큰 영리 경영 의료 회사이다." WHERE symbol = "ANTM";
UPDATE company_info SET kr_name = "아메리칸 익스프레스", kr_desc = "아메리칸 익스프레스 컴퍼니(American Express Company)는 미국 뉴욕 로어 맨해튼 배터리 파크 시티의 베이지 스트리트 200번지에 본사를 둔 다국적 금융 서비스 기 
업이다." WHERE symbol = "AXP";
UPDATE company_info SET kr_name = "보잉", kr_desc = "보잉사는 비행기, 로터크래프트, 로켓, 위성, 통신 장비, 미사
일을 설계, 제조, 판매하는 미국의 다국적 기업이다. 그 회사는 임대 및 제품 지원 서비스도 제공합니다." WHERE symbol = "BA";
UPDATE company_info SET kr_name = "Brookfield AM", kr_desc = "브룩필드자산운용은 대표적인 글로벌 대체자산운용사
로 실물자산 투자 규모가 가장 큰 기업 중 하나다." WHERE symbol = "BAM";
UPDATE company_info SET kr_name = "부킹홀딩스", kr_desc = "부킹 홀딩스 주식회사(Booking Holdings Inc.)는 델라웨
어에서 조직되고 코네티컷주 노워크에 본사를 둔 미국의 여행 기술 기업으로, 이름 및 대표 상품인 Booking.com, Priceline.com, Agoda.com, Agoda.com, Chickflights, Rentalcars.com, Momondo 및 OpenTable을 포함한 여러 여행 요금 집계
 및 메타 검색 엔진을 소유하고 운영하고 있습니다." WHERE symbol = "BKNG";
UPDATE company_info SET kr_name = "블랙록", kr_desc = "블랙록(BlackRock, Inc.)은 미국의 다국적 투자 관리 회사이
다." WHERE symbol = "BLK";
UPDATE company_info SET kr_name = "브리스톨 마이어스 스퀴브", kr_desc = "브리스톨 마이어스 스퀴브(BMS)는 미국  
뉴욕에 본사를 둔 다국적 제약회사이다. 브리스톨 마이어스 스퀴브는 암, 에이즈, 심혈관 질환, 당뇨병, 간염, 류마티 
스 관절염, 정신 질환 등 여러 치료 분야에서 처방 의약품과 생물의학을 제조하고 있다." WHERE symbol = "BMY";      
UPDATE company_info SET kr_name = "Blackstone Group", kr_desc = "블랙스톤 그룹은 부동산, 사모펀드, 헤지펀드 솔 
루션, 신용, 세컨더리 펀드, 공적 부채 및 지분 전략, 다중 자산 분류를 전문으로 하는 대체 자산 관리 회사이다. 이  
회사는 뉴욕, 뉴욕에 본사를 두고 있으며 아시아, 유럽, 북미 전역에 추가 사무소를 두고 있다." WHERE symbol = "BX";UPDATE company_info SET kr_name = "씨티그룹", kr_desc = "시티그룹(Citygroup Inc.)은 미국의 다국적 투자 은행이자
 금융 서비스 기업이다. 1998년 시티코프와 트레블러스 그룹이 합병하여 설립되었으며 2002년 트래블러스 그룹이 분리 
되었다. 씨티그룹은 씨티은행의 지주회사인 씨티코프와 몇몇 국제법인을 소유하고 있다. 씨티그룹은 델라웨어에 설립되
었다." WHERE symbol = "C";
UPDATE company_info SET kr_name = "캐터필러", kr_desc = "캐터필러 주식회사(Catterpillar Inc.)는 미국의 포춘지 
선정 100대 기업 중 하나로, 전 세계 딜러 네트워크를 통해 기계, 엔진, 금융 제품 및 보험을 설계, 개발, 엔지니어링, 제조, 판매합니다." WHERE symbol = "CAT";
UPDATE company_info SET kr_name = "차터커뮤니케이션", kr_desc = "챠터 커뮤니케이션스(Charter Communications, Inc.)는 미국의 통신 및 대중 매체 기업으로, 챠터 스펙트럼(Charter Spectrum)이라는 브랜드 서비스를 제공하고 있다." 
WHERE symbol = "CHTR";
UPDATE company_info SET kr_name = "코노코필립스", kr_desc = "코노코필립스(ConocoPhillips)는 탄화수소 탐사에 참 
여하는 미국의 다국적 기업이다. 본부는 텍사스주 휴스턴의 에너지 코리더 지구에 있다." WHERE symbol = "COP";      
UPDATE company_info SET kr_name = "CVS헬스", kr_desc = "CVS 헬스(CVS Health, 이전 명칭: CVS Caremark Corporation, CVS Caremark)는 미국의 약국 체인점인 CVS 약국, 약국 혜택 관리자인 CVS Caremark, 의료 보험 제공자인 Aetna 등 
을 소유하고 있는 의료 회사이다. 본사는 로드아일랜드 운소켓에 있다." WHERE symbol = "CVS";
UPDATE company_info SET kr_name = "디어", kr_desc = "존 디어(John Deere)는 미국의 농기계, 건설기계, 디젤엔진,  
기어박스 등 중장비 제조회사이다." WHERE symbol = "DE";
UPDATE company_info SET kr_name = "에스티로더", kr_desc = "에스티로더 컴퍼니(Estee Lauder Companies Inc.)는 미 
국 뉴욕 맨해튼 미드타운에 본사를 둔 프레스티지 스킨케어, 메이크업, 향기 및 헤어 케어 제품을 제조 및 판매하는 다
국적 기업이다. 이 회사는 디지털 커머스 채널과 소매 채널을 통해 전세계에 유통되는 다양한 브랜드 포트폴리오를 소 
유하고 있다." WHERE symbol = "EL";
UPDATE company_info SET kr_name = "제너럴 일렉트릭", kr_desc = "제너럴 일렉트릭 컴퍼니(GE)는 미국의 다국적 기업
이다. 2018년 현재 이 회사는 항공, 의료, 전력, 재생 에너지, 디지털 산업, 적층 제조 및 벤처 캐피털 및 금융 부문을
 통해 운영되고 있다." WHERE symbol = "GE";
UPDATE company_info SET kr_name = "골드만 삭스", kr_desc = "골드만삭스 그룹은 미국 뉴욕에 본사를 둔 다국적 투자
 은행이다. 그것은 투자 관리, 증권, 자산 관리, 프라임 브로커리지, 증권 인수 서비스를 제공한다. 기관투자가에게 투
자은행을 제공하기도 한다." WHERE symbol = "GS";
UPDATE company_info SET kr_name = "하니웰", kr_desc = "허니웰 인터내셔널은 미국 노스캐롤라이나주 샬럿에 본사를 
둔 다국적 기업이다. 그것은 주로 항공우주, 빌딩 기술, 성능 재료 및 기술(PMT), 안전 및 생산성 솔루션(SPS)의 네 가
지 비즈니스 분야에서 운영된다." WHERE symbol = "HON";
UPDATE company_info SET kr_name = "International Business Machines", kr_desc = "IBM(International Business Machines Corporation)은 미국 뉴욕주 아몽크에 본사를 둔 다국적 기술 기업이다. 1911년 뉴욕주 엔디콧에서 컴퓨터 태블레
이팅 레코딩 컴퍼니(CTR)로 설립되었으며 1924년 국제 비즈니스 머신으로 이름이 바뀌었다. IBM은 뉴욕에 본사를 두고 
있습니다. IBM은 컴퓨터 하드웨어, 미들웨어 및 소프트웨어를 생산하고 판매하며 메인프레임 컴퓨터에서 나노 기술에  
이르기까지 다양한 분야에서 호스팅 및 컨설팅 서비스를 제공합니다. IBM은 또한 28년 연속 기업이 창출한 가장 많은  
연간 미국 특허 기록(2020년 기준)을 보유하고 있는 주요 연구 기관입니다. IBM의 발명품으로는 현금 자동 입출금기(ATM), 플로피 디스크, 하드 디스크 드라이브, 마그네틱 스트라이프 카드, 관계형 데이터베이스, SQL 프로그래밍 언어, UPC 바코드, 동적 랜덤 액세스 메모리(DRAM) 등이 있다. System/360으로 대표되는 IBM 메인프레임은 1960년대와 1970년대
에 지배적인 컴퓨팅 플랫폼이었다." WHERE symbol = "IBM";
UPDATE company_info SET kr_name = "인튜이트", kr_desc = "인튜이트는 금융 소프트웨어를 전문으로 하는 미국의 기업
이다. 인튜이트의 제품으로는 세금 준비 애플리케이션 터보택스, 개인 금융 앱 민트, 중소기업 회계 프로그램 퀵북스  
등이 있다." WHERE symbol = "INTU";
UPDATE company_info SET kr_name = "인튜이티브 서지컬", kr_desc = "인비튜얼 서전 주식회사(Invious Surgical, Inc.)는 다빈치 수술 시스템을 통해 최소 침습적 수술을 통해 환자의 임상 결과를 개선하도록 설계된 로봇 제품을 개발, 제
조 및 판매하는 미국 기업이다." WHERE symbol = "ISRG";
UPDATE company_info SET kr_name = "린드", kr_desc = "린드 plc는 다국적 화학 회사이다. 시장점유율과 매출에서 가 
장 큰 산업용 가스 회사이다. 의료, 석유 정제, 제조, 식음료 탄산, 광섬유, 철강, 항공우주, 화학, 전자 및 수처리 산
업의 고객들에게 서비스를 제공한다. 이 회사의 1차 사업은 산소, 질소, 아르곤, 희소가스를 포함한 대기 가스와 이산 
화탄소, 헬륨, 수소, 전자 가스, 특수 가스, 아세틸렌을 포함한 공정 가스의 제조 및 유통이다." WHERE symbol = "LIN";
UPDATE company_info SET kr_name = "록히드 마틴", kr_desc = "록히드 마틴(Lockheed Martin)은 미국의 항공우주, 국 
방, 정보 보안 및 기술 기업으로 전 세계적으로 관심을 가지고 있다. 본부는 메릴랜드주 노스베데스다에 있다." WHERE 
symbol = "LMT";
UPDATE company_info SET kr_name = "로우스", kr_desc = "로우즈 컴퍼니(Lowe's Companies, Inc.)는 주택 개량을 전문
으로 하는 미국의 소매 기업이다. 노스캐롤라이나주 무어스빌에 본사를 둔 이 회사는 미국과 캐나다에 체인점을 운영하
고 있다." WHERE symbol = "LOW";
...
UPDATE company_info SET kr_name = "메드트로닉", kr_desc = "메드트로닉(Medtronic)은 아일랜드계 미국 의료 기기 회
사이다. 메드트로닉은 미국 미네소타주 프리들리에 본사가 있다." WHERE symbol = "MDT";
UPDATE company_info SET kr_name = "3M", kr_desc = "3M 컴퍼니는 산업, 근로자 안전, 미국 의료 및 소비재 분야에서 
활동하고 있는 미국의 다국적 기업이다. 본 업체는 접착제, 연마재, 라미네이트, PFP, 개인 보호 장비, 윈도우 필름,  
페인트 보호 필름, 치과 및 치아 교정 제품, 전기 및 전자 연결 및 절연 재료, 의료 제품, 자동차 관리 제품, 전자 순 
환기 등 여러 브랜드의 60,000개 이상의 제품을 생산하고 있습니다.Uits, 의료 소프트웨어 및 광학 필름. 미네소타주  
세인트폴 교외 메이플우드에 본부를 두고 있다." WHERE symbol = "MMM";
UPDATE company_info SET kr_name = "알트리아 그룹", kr_desc = "알트리아 그룹(Altria Group, Inc.)은 미국의 기업이
자 세계에서 가장 큰 담배, 담배 및 관련 제품 생산 및 마케팅 업체 중 하나이다. 본사는 버지니아주 리치먼드 외곽의 
비법인 헨리코 카운티에 있다." WHERE symbol = "MO";
UPDATE company_info SET kr_name = "마이크론 테크놀로지", kr_desc = "마이크론 테크놀로지(Micron Technology, Inc.)는 미국의 컴퓨터 메모리 및 동적 랜덤 액세스 메모리, 플래시 메모리 및 USB 플래시 드라이브를 포함한 컴퓨터 데이 
터 스토리지 제조업체입니다. 본사는 아이다호주 보이시에 있다." WHERE symbol = "MU";
UPDATE company_info SET kr_name = "넥스테라", kr_desc = "넥스트에라 에너지(NextEra Energy, Inc.)는 약 46기가와
트의 발전 용량, 2017년 170억 달러가 넘는 매출, 미국과 캐나다 전역에서 약 14,000명의 직원을 보유한 미국의 에너지
 기업이다. 자회사는 플로리다 전력 및 라이트(FPL), 넥스트에라 에너지 자원, 넥스트에라 에너지 파트너스, 걸프 전력
 회사, 넥스트에라 에너지 서비스를 포함한다." WHERE symbol = "NEE";
UPDATE company_info SET kr_name = "서비스나우", kr_desc = "ServiceNow는 캘리포니아 주 산타클라라에 본사를 둔 미
국의 소프트웨어 회사로, 기업이 기업 운영을 위한 디지털 워크플로우를 관리할 수 있도록 지원하는 클라우드 컴퓨팅  
플랫폼을 개발합니다." WHERE symbol = "NOW";
UPDATE company_info SET kr_name = "프로로지스", kr_desc = "프롤로지스는 미국 캘리포니아주 샌프란시스코에 본사를
 둔 부동산투자신탁으로 물류시설에 투자하고 있으며 글로벌 공급망의 소비 측면에 초점을 맞추고 있다." WHERE symbol = "PLD";
UPDATE company_info SET kr_name = "페이팔 홀딩스", kr_desc = "페이팔 홀딩스 주식회사(PayPal Holdings, Inc.)는  
온라인 송금을 지원하는 대부분의 국가에서 온라인 결제 시스템을 운영하는 미국 회사이며 수표와 우편환과 같은 전통 
적인 종이 방법에 대한 전자적 대안 역할을 한다. 이 회사는 온라인 판매업체, 경매 사이트 및 기타 많은 상업적 사용 
자들을 위한 결제 프로세서로 운영되며 수수료를 부과한다." WHERE symbol = "PYPL";
UPDATE company_info SET kr_name = "레이시온 테크놀로지스", kr_desc = "레이시온 테크놀로지스(Raytheon Technologies Corporation)는 미국 매사추세츠주 월섬에 본사를 둔 다국적 항공우주 및 방위산업 기업이다. 매출과 시가총액 면에
서 세계 최대의 항공우주, 정보 서비스 제공업체 및 방위산업 제조업체 중 하나이다. 레이시온 테크놀로지스(RTX)는 항
공기 엔진, 항전, 항공우주, 항공구조, 사이버보안, 유도미사일, 방공시스템, 위성, 드론 등 항공우주 및 방위산업 분 
야의 첨단 기술 제품을 연구, 개발, 제조하고 있다." WHERE symbol = "RTX";
UPDATE company_info SET kr_name = "스타벅스", kr_desc = "스타벅스(Starbucks)는 미국 워싱턴주 시애틀에 본사를 둔
 커피 전문점 체인이다. 세계에서 가장 큰 커피숍 체인점으로서 스타벅스는 미국의 제2의 커피 문화를 대표하는 주요  
기업으로 여겨진다." WHERE symbol = "SBUX";
...
UPDATE company_info SET kr_name = "쇼피파이", kr_desc = "상업 회사인 Shopify Inc.는 캐나다, 미국, 영국, 호주,  
라틴 아메리카 및 국제적으로 상업 및 서비스 플랫폼을 제공합니다. 이 회사는 캐나다 오타와에 본사를 두고 있다." WHERE symbol = "SHOP";
UPDATE company_info SET kr_name = "스노우플레이크", kr_desc = "Snowflake Inc.는 미국과 국제적으로 클라우드 기반
 데이터 플랫폼을 제공합니다. 본사는 캘리포니아주 샌머테이오에 있다." WHERE symbol = "SNOW";
UPDATE company_info SET kr_name = "S&P Global", kr_desc = "S&P 글로벌 주식회사(S&P Global Inc.)는 미국 뉴욕 맨 
해튼에 본사를 둔 상장 기업이다. 주요 업무 분야는 재무 정보와 분석입니다." WHERE symbol = "SPGI";
UPDATE company_info SET kr_name = "스트라이커", kr_desc = "스트리커 코퍼레이션은 미국 미시간주 캘러마주에 본사 
를 둔 다국적 의료 기술 기업이다. Stryker의 제품에는 관절 교체 및 외상 수술에 사용되는 임플란트, 수술 장비 및 수
술 항법 시스템, 내시경 및 통신 시스템, 환자 치료 및 응급 의료 장비, 신경외과, 신경혈관 및 척추 기기, 다양한 의 
료 전문분야에 사용되는 기타 의료 기기 제품이 포함된다." WHERE symbol = "SYK";
UPDATE company_info SET kr_name = "AT&T", kr_desc = "AT&T는 미국 델라웨어주의 다국적 지주회사이다. 세계에서 가 
장 큰 통신 회사이며, 휴대 전화 서비스 제공 업체 중 두 번째로 크다." WHERE symbol = "T";
UPDATE company_info SET kr_name = "타깃", kr_desc = "타깃 코퍼레이션은 미국의 소매 기업이다. 이들의 소매 형식에
는 할인점 Target, 하이퍼마켓 SuperTarget, 그리고 Target 브랜드로 통합되기 전에 이전에 CityTarget과 TargetExpress로 명명된 소형 매장이 포함된다." WHERE symbol = "TGT";
UPDATE company_info SET kr_name = "티모바일", kr_desc = "T-Mobile US, Inc.는 미국의 무선 네트워크 사업자이다.  
본사는 워싱턴주 벨뷰에 위치해 있으며 시애틀 대도시권과 캔자스주 오버랜드파크에 위치해 있다." WHERE symbol = "TMUS";
UPDATE company_info SET kr_name = "텍사스인스트루먼츠", kr_desc = "텍사스 인스트루먼트 주식회사(TI, Texas Instruments Incorporated)는 미국 텍사스주 댈러스에 본사를 둔 반도체 및 다양한 집적회로를 설계 및 제조하는 기술 기업 
이다. 매출액 기준 세계 10대 반도체 기업 중 하나다." WHERE symbol = "TXN";
UPDATE company_info SET kr_name = "유니온 퍼시픽", kr_desc = "유니온 퍼시픽 코퍼레이션은 철도 지주회사이다. 1969년 유타에 설립되었으며 본사는 네브래스카주 오마하에 있다. 현재 델라웨어에 등록된 유니언 퍼시픽 철도의 모회사이
다." WHERE symbol = "UNP";
UPDATE company_info SET kr_name = "조에티스", kr_desc = "Zoetis Inc.는 미국 제약회사로, 애완 동물과 가축을 위한
 의약품 및 백신의 세계 최대 생산업체입니다." WHERE symbol = "ZTS";